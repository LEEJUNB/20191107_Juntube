...
export const home = (req,res) => 
    res.render("home", {pageTitle:"variable_pagetitle is Home!!"}); // home is home.pug, 'pageTitle' is variable and "Home" is value. pageTitle이 home템플릿(home.pug)로 전달된다.
export const search = (req,res) => 
    res.render("search", {pageTitle:"variable_pagetitle is Search!!"});
